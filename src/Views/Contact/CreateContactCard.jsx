...
const CreateContactCard = ({ setAddContact, addContact, contact }) => {
  ...
  const { getFieldProps, errors, resetForm, values, setValues } = useFormik({
    initialValues: {
      type: '',
      company: '',
      name: '',
  ...
  useEffect(() => {
    setValues({ ...values, phone: contact });
  }, [contact]);
  ...
  return (
    <div
      ...
      } fixed top-1/2 right-1/2 transform translate-x-1/2 -translate-y-1/2 bg-white mt-10 mx-4 flex flex-col items-center z-50 shadow-2xl`}
    >
      ...
      <div className=" flex justify-between items-center p-4 mb-4 w-full">
